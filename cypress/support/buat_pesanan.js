 ...
 Cypress.Commands.add('buatPesananSatuanCOD', () => {
  ...
  qty=1
    ...
    cy.get(':nth-child(2) > .card.mb-3 > .card-body > :nth-child(2) > .form-control').click()
    cy.get(':nth-child(2) > .content > .show > .modal-dialog > .modal-content > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    cy.get('.modal-content > .modal-body > .row > :nth-child(1) > .btn',{ timeout: 10000 }).click()
    cy.get(':nth-child(2) > .content > .show > .modal-dialog > .modal-content > form > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    ...
    cy.get('#vs4__option-0 > .d-center').should('contain.text', 'TANDES', { timeout: 10000 })
    cy.get('#vs4__option-0 > .d-center').click()
    cy.get('.selected').invoke('text').should('include', 'TANDES')
    cy.get('#addr_detail').type('Test automation oleh bhasri pak kurir, jadi hiraukan saja')
    cy.get('.show > .modal-dialog > .modal-content > form > .modal-body > .row > :nth-child(8) > .btn').click()
    // memasukkan data penerima
    cy.get('.card.mb-3 > .card-body > .mb-0 > .form-control > .fi').click()
    cy.get(':nth-child(2) > .show > .modal-dialog > .modal-content > form > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    ...
    cy.get('#vs3__option-0 > .d-center').should('be.visible').and('contain.text', 'BALONGBENDO', { timeout: 10000 })
    cy.get('#vs3__option-0 > .d-center',{ timeout: 10000 }).click({ timeout: 10000 })
    cy.get('.modal-body > :nth-child(2) > :nth-child(4) > .form-control').type('Test automation oleh bhasri pak kurir, jadi hiraukan saja')
    cy.get(':nth-child(2) > :nth-child(7) > .btn', { timeout: 10000 }).click()
    // masukkan detail paket
    cy.get('.card.mb-0 > .card-body > .form-group > .form-control > .fi',{ timeout: 10000 }).click()
    cy.get('[aria-modal="true"] > .modal-dialog > .modal-content > form > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    ...
    // pilih cod dan non cod
      // cod
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(1) > .form-control > .icheck-material-orange > .form-check-label').click()
    cy.wait(5000)
    cy.pilihKurirIDX()
    ...
    // tulis note
    cy.get('#note').type('Test automation oleh bhasri pak kurir, jadi hiraukan saja')


    cy.get('.flex-column > :nth-child(1) > :nth-child(2)').should('contain', '1 Kg').and('be.visible')
    cy.get('.mt-3 > .flex-column > :nth-child(2) > :nth-child(2)').should('contain.text', 'Rp 50,000').and('be.visible')
  ...
  Cypress.Commands.add('buatPesananSatuanNonCOD', () => {
    ...
    cy.contains('h1', 'Buat Pesanan',{ timeout: 10000 }).should('be.visible')
    // memasukkan data pengirim
    cy.get(':nth-child(2) > .card.mb-3 > .card-body > :nth-child(2) > .form-control',{ timeout: 10000 }).click()
    cy.get(':nth-child(2) > .content > .show > .modal-dialog > .modal-content > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    cy.get('.modal-content > .modal-body > .row > :nth-child(1) > .btn',{ timeout: 10000 }).click()
    cy.get(':nth-child(2) > .content > .show > .modal-dialog > .modal-content > form > .modal-header > .modal-title',{ timeout: 10000 }).should('be.visible')
    const generateUniqueSenderName = () => {
    ...
    cy.get('#vs3__option-0 > .d-center', { timeout: 10000 }).should('be.visible').and('contain.text', 'BENOWO').click()
    ...
    // pilih cod dan non cod
    // non cod
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(2) > .form-control > .icheck-material-orange > .form-check-label').click()
    cy.wait(5000)
